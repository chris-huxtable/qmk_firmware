...
/* Lower
 * ,-----------------------------------------------------------------------------------.
 * |Sleep |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F7  |  F8  |  F9  |  F10 | Bksp |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Tab  | Home |      |  |   |  \   |  -   |   _  |   /  |   |  |      | End  | Del  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |   ~  | Pg Up|  <   |  {   |  (   |  [   |   ]  |   )  |   }  |   >  | Pg Dn|  |   |
...
[_LOWER] = LAYOUT_preonic_grid(
  SLP_DSP,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10, KC_BSPC,
  ...
  _______, _______, _______, _______, _______, KC_MPLY, KC_MPLY, _______, KC_MPRV, KC_VOLU, KC_VOLD, KC_MNXT
),

/* Raise
 * ,-----------------------------------------------------------------------------------.
 * | Lock |MsnCtl|SptLgt|CntPnl|      |      |      |      |      |      |      | Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Tab  | Home |      |  |   |  \   |  -   |   _  |   /  |   |  |      | End  | Del  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |   ~  | Pg Up|  <   |  {   |  (   |  [   |   ]  |   )  |   }  |   >  | Pg Dn|  |   |
...
[_RAISE] = LAYOUT_preonic_grid(
  LCK_DSP, KC_MCTL, KC_ASST, KC_CPNL, _______, _______, _______, _______, _______, _______, _______, KC_BSPC,
  KC_TAB,  KC_HOME, XXXXXXX, KC_PIPE, KC_BSLS, KC_PMNS, KC_UNDS, KC_PSLS, KC_PIPE, XXXXXXX,  KC_END,  KC_DEL,
  KC_TILD, KC_PGUP, KC_LABK, KC_LCBR, KC_LPRN, KC_LBRC, KC_RBRC, KC_RPRN, KC_RCBR, KC_RABK, KC_PGDN, KC_PIPE,
  _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_PPLS, KC_PMNS, KC_UNDS, KC_EQL,  XXXXXXX, XXXXXXX, XXXXXXX, _______,
  _______, _______, _______, _______, _______, KC_MPLY, KC_MPLY, _______, KC_MPRV, KC_VOLU, KC_VOLD, KC_MNXT
